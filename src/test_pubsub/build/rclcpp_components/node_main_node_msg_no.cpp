...
#define NODE_MAIN_LOGGER_NAME "node_msg_no"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtester_component.a";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_pubsub::NodeMsgNo>";
