...
#define NODE_MAIN_LOGGER_NAME "all_activator_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libeverything_launcher.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<managed_talker::LifeActivator>";
