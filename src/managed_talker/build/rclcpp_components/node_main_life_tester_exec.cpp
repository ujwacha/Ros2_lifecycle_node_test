...
#define NODE_MAIN_LOGGER_NAME "life_tester_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblife_tester.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<managed_talker::Life_Talker>";
