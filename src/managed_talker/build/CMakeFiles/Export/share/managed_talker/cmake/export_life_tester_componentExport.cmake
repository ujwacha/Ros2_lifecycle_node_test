...
foreach(_expectedTarget managed_talker::life_tester)
...
# Create imported target managed_talker::life_tester
add_library(managed_talker::life_tester SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_life_tester_componentExport-*.cmake")
